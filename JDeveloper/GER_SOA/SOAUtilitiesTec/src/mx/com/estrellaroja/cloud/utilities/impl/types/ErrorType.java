...
/**
 * Standard way to indicate that an error
 ...
 *         &lt;element name="FailedService" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlType(name = "ErrorType",
         propOrder = { "errorCode", "shortDescription", "description", "businessProcess", "failedService", "timeStamp"
    })
public class ErrorType {
    ...
    @XmlElement(name = "FailedService", required = true)
    protected String failedService;
    ...
    /**
     * Gets the value of the failedService property.
     *
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the failedService property.
     *
     * @param value
     *     allowed object is
     *     {@link String }
     *
     */
    public void setFailedService(String value) {
        this.failedService = value;
    }
