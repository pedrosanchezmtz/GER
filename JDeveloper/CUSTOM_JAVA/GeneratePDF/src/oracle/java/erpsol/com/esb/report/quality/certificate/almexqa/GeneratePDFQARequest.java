 ...
 *       &lt;sequence>
 *         &lt;element name="nameFormat" type="{http://www.w3.org/2001/XMLSchema}string"/>
 ...
 *                 &lt;attribute name="selloSeguridad" type="{http://www.w3.org/2001/XMLSchema}string" />
...
@XmlRootElement(name = "generatePDFQARequest")
public class GeneratePDFQARequest implements Serializable{
    ...
    protected byte[] logo;
    @XmlElement(required = true)
    protected List<GeneratePDFQARequest.Certificado> certificado;

    /**
     * Obtiene el valor de la propiedad nameFormat.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad nameFormat.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     ...
     * {@link GeneratePDFQARequest.Certificado }
     * 
     * 
     */
    public List<GeneratePDFQARequest.Certificado> getCertificado() {
        if (certificado == null) {
            certificado = new ArrayList<GeneratePDFQARequest.Certificado>();
        }
    ...
    public static class Certificado {
        ...
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.CaracteristicasSensoriales> caracteristicasSensoriales;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.EspecificacionesAnaliticas> especificacionesAnaliticas;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.MetalesPesados> metalesPesados;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.Micotoxinas> micotoxinas;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.Microbiologico> microbiologico;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.AnalisisProducto> analisisProducto;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.DefectosMayores> defectosMayores;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.DefectosMenores> defectosMenores;
        @XmlElement(required = true)
        protected List<GeneratePDFQARequest.Certificado.DefectosCriticos> defectosCriticos;
        ...
        @XmlAttribute(name = "selloSeguridad")
        protected String selloSeguridad;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.CaracteristicasSensoriales }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.CaracteristicasSensoriales> getCaracteristicasSensoriales() {
            if (caracteristicasSensoriales == null) {
                caracteristicasSensoriales = new ArrayList<GeneratePDFQARequest.Certificado.CaracteristicasSensoriales>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.EspecificacionesAnaliticas }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.EspecificacionesAnaliticas> getEspecificacionesAnaliticas() {
            if (especificacionesAnaliticas == null) {
                especificacionesAnaliticas = new ArrayList<GeneratePDFQARequest.Certificado.EspecificacionesAnaliticas>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.MetalesPesados }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.MetalesPesados> getMetalesPesados() {
            if (metalesPesados == null) {
                metalesPesados = new ArrayList<GeneratePDFQARequest.Certificado.MetalesPesados>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.Micotoxinas }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.Micotoxinas> getMicotoxinas() {
            if (micotoxinas == null) {
                micotoxinas = new ArrayList<GeneratePDFQARequest.Certificado.Micotoxinas>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.Microbiologico }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.Microbiologico> getMicrobiologico() {
            if (microbiologico == null) {
                microbiologico = new ArrayList<GeneratePDFQARequest.Certificado.Microbiologico>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.AnalisisProducto }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.AnalisisProducto> getAnalisisProducto() {
            if (analisisProducto == null) {
                analisisProducto = new ArrayList<GeneratePDFQARequest.Certificado.AnalisisProducto>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.DefectosMayores }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.DefectosMayores> getDefectosMayores() {
            if (defectosMayores == null) {
                defectosMayores = new ArrayList<GeneratePDFQARequest.Certificado.DefectosMayores>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.DefectosMenores }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.DefectosMenores> getDefectosMenores() {
            if (defectosMenores == null) {
                defectosMenores = new ArrayList<GeneratePDFQARequest.Certificado.DefectosMenores>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GeneratePDFQARequest.Certificado.DefectosCriticos }
         * 
         * 
         */
        public List<GeneratePDFQARequest.Certificado.DefectosCriticos> getDefectosCriticos() {
            if (defectosCriticos == null) {
                defectosCriticos = new ArrayList<GeneratePDFQARequest.Certificado.DefectosCriticos>();
            }
        ...
        /**
         * Obtiene el valor de la propiedad selloSeguridad.
         * 
         * @return
         *     possible object is
         *     {@link String }
        ...
        /**
         * Define el valor de la propiedad selloSeguridad.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setSelloSeguridad(String value) {
            this.selloSeguridad = value;
        }
