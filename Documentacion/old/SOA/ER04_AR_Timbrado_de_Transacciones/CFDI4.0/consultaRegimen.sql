...
and HP.party_id in (300000036240000,300000010650826)



select ATTRIBUTE1 from HZ_ORGANIZATION_PROFILES
select ATTRIBUTE1 from HZ_PERSON_PROFILES
select ATTRIBUTE1 from HZ_CUST_ACCOUNTS


SELECT "RA_CUSTOMER_TRX_ALL"."CUSTOMER_TRX_ID" AS "CUSTOMER_TRX_ID",
       ...
       "HZ_LOCATIONS"."ADDRESS4" AS "issuer_colony", 
       "HZ_LOCATIONS"."POSTAL_CODE" AS "issuer_zip_code", 
       "HZ_LOCATIONS"."CITY" AS "issuer_municipality", 
       ...
       /*(SELECT "LINES"."DESCRIPTION"
         ...
         WHERE "LINES"."CUSTOMER_TRX_ID"="RA_CUSTOMER_TRX_ALL"."CUSTOMER_TRX_ID"
           ...
           AND "LINES"."LINE_TYPE"='LINE'
           AND "MEMO"."ATTRIBUTE2" = 'Y'
           AND ROWNUM=1
           AND UPPER("LINES"."DESCRIPTION") LIKE '%MILLAR%') AS "local_retention_name",
       (SELECT TRIM(TO_CHAR("MEMO"."ATTRIBUTE3"/100, '0.99'))
          FROM "FUSION"."RA_CUSTOMER_TRX_LINES_ALL" "LINES",
               "FUSION"."AR_MEMO_LINES_ALL_B"       "MEMO"
         WHERE "LINES"."CUSTOMER_TRX_ID"="RA_CUSTOMER_TRX_ALL"."CUSTOMER_TRX_ID"
           AND "MEMO"."MEMO_LINE_SEQ_ID" = "LINES"."MEMO_LINE_SEQ_ID"
           AND "LINES"."LINE_TYPE"='LINE'
           AND "MEMO"."ATTRIBUTE2" ='Y'
           AND UPPER("LINES"."DESCRIPTION") LIKE '%MILLAR%'
           AND ROWNUM=1) AS "local_retention_percentage",
       (SELECT ABS(SUM("LINES"."EXTENDED_AMOUNT"))
         ...
         WHERE "LINES"."CUSTOMER_TRX_ID"="RA_CUSTOMER_TRX_ALL"."CUSTOMER_TRX_ID"
           ...
           AND "LINES"."LINE_TYPE"='LINE'
           AND UPPER("LINES"."DESCRIPTION") LIKE '%MILLAR%'
           AND "MEMO"."ATTRIBUTE2" ='Y') AS "local_retencion_amount",*/ --Modif 261118
		   T1.local_retencion_name AS "local_retention_name",
		   T1.local_retention_percentage AS "local_retention_percentage",
		   ABS(T1.local_retencion_amount) AS "local_retention_amount",
       (SELECT ABS(SUM("LINES"."EXTENDED_AMOUNT")) 
          FROM "FUSION"."RA_CUSTOMER_TRX_LINES_ALL" "LINES"
         WHERE "LINES"."CUSTOMER_TRX_ID"="RA_CUSTOMER_TRX_ALL"."CUSTOMER_TRX_ID"
	   ...
	   ABS(t1.retention_vat) as "retention_vat",  --monto
    ...
    END ) AS "serie",
	   ...
	   (CASE 
		WHEN "XLE_REGISTRATIONS"."REGISTRATION_NUMBER" in ('AMP521016875','CTE060224DA3','TTE020806LF4','VER870629GN3','MLO120419J96','ATM000204JJ2','TTP050504P51','CIT071219IH4','IPB0912082X8') THEN '624'
		ELSE '601'
		END ) AS "issuer_tax_regime", -- modif IMM 041218	   
...
/*      
	  CASE
       ...
       END 
*/
       "RA_CUSTOMER_TRX_ALL"."ATTRIBUTE2" AS "related_cfdi"
 ...
 WHERE "RA_CUSTOMER_TRX_ALL"."CREATION_DATE">=TO_DATE('06/09/2017', 'DD/MM/YYYY')
   ...
   --AND "RA_CUSTOMER_TRX_ALL"."TRX_NUMBER" IN ('42000')
