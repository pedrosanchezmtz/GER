--Query que pasa las facturas de Sumas 2 a Tabla puente Valor de entrada es DD/MM/YY
DECLARE
...
/****************************** PASO 1 XXER_TBL_PUENTE_AUXILIAR *******************************************************************/
          ...
          AND TRUNC(H1.FECHA_MOVIMIENTO)= DIA
...
/********************** PASO 3 XXER_TBL_PUENTE_HEADER *******************************************************************/
           ...
           WHERE TRUNC(H1.FECHA_MOVIMIENTO)  = DIA
